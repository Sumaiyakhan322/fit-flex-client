...
const ForumCard = ({ forum }) => {
  ...
  return (
    <div>
      <div
        key={forum._id}
        className="mb-6 flex  items-center gap-6   flex-col md:flex-row"
      >
        <div className="mb-6 ml-auto w-full   px-3 md:mb-0 md:w-3/12  h-full">
          ...
          >
            <img src={forum.img} className="w-full h-full" alt="Louvre" />
            <a href="#!">
        ...
        <div className="mb-6 mr-auto w-full  px-3 md:mb-0 md:w-9/12 xl:w-7/12 ">
          ...
          <div className="mb-3 text-[#c3bd2e] flex items-center justify-center text-sm font-medium text-danger dark:text-danger-500 md:justify-start">
            {forum.role === "admin" ? (
              <MdAdminPanelSettings className="text-3xl text-[#c3bd2e]"></MdAdminPanelSettings>
            ) : (
              <MdOutlineAddModerator className="text-3xl text-[#c3bd2e]"></MdOutlineAddModerator>
            )}
            Gym
          </div>
          <p className="mb-6 ">
          ...
          <p className="">{forum.des}</p>
          <div className="text-2xl text-[#c3bd2e] ">
            {" "}
            {user && (
              <>
