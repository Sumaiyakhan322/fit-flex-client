      ...
      <ol className="relative border-s border-gray-200 dark:border-gray-700">
        <li className="mb-10 ms-4">
          ...
          <p className="mb-4 text-base font-bold text-black my-4">
            My Package Name:
            <span className="text-[#c3bd2e] uppercase">
              {myBooked?.packageName}
            </span>
          </p>
          <p className="mb-4 text-base font-bold text-black ">
            My Trainer Name:
            <span className="text-[#c3bd2e] uppercase">
              {myBooked?.trainerName}
            </span>
          </p>
          <p className="mb-4 text-base font-bold text-black ">
            My Trainer Name:
            <span className="text-[#c3bd2e] uppercase">
              {myBooked?.trainerEmail}
            </span>
          </p>
          <p className="mb-4 text-base  text-black ">
            Cardio Blast: Description: Join our Cardio Blast class for an
            exhilarating workout that gets your heart pumping and calories
            burning. This high-energy session combines dynamic cardio routines
            with upbeat music, ensuring an enjoyable and effective way to
            improve cardiovascular health and boost endurance.
          </p>
        </li>
        {/* <li className="mb-10 ms-4">
