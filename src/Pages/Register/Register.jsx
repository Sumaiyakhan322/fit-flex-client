        ...
        <div className="hero-content text-center text-neutral-content md:w-1/2 w-full">
          <div className="card w-full  shadow-2xl  box">
            ...
            <div>
              <form className="card-body" onSubmit={handleSubmit}>
                ...
                <div className="form-control mt-6 ">
                  <input
                    type="submit"
                    className=" btn bg-gradient-to-r from-[#193e51] to-[#146666]hover:bg-white hover:border hover:border-[#193e51] text-[#fcf540] font-bold"
                    value={"Register"}
                  />
                </div>
              </form>
            ...
            <p className="text-black">
              ...
              <Link to="/login" className=" text-[#c3bd2e] font-bold underline">
                Log in
              </Link>{" "}
            </p>
