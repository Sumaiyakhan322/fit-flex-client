...
const DetailsClass = () => {
  ...
  const { image, timeSlot, day, trainerName, className, classDescription } =
    data;
  return (
    <div>
      ...
      <div className="hero min-h-screen bg-base-200 w-10/12 mx-auto my-20 rounded-lg">
        <div className="hero-content flex-col lg:flex-row-reverse px-10">
          ...
          <div className="">
            ...
            <p className="py-6 font-bold">
              Class Description:
              <span className="text-[#146666]">{classDescription}</span>
            </p>
            <Link to={"/trainer"}>
              <button className=" md:w-1/2 mt-4  w-11/12 rounded text-[#fcf540] bg-gradient-to-r from-[#193e51] to-[#146666]  px-7 pb-2.5 pt-3 text-sm font-medium uppercase  ">
                Join Now
              </button>
            </Link>
          </div>
